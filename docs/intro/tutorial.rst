...
object classes that they decorate into the default registry, which ``get_item``
uses to determine which page object class to use based on its input parameters
(URL and item class).
